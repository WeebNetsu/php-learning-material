...
<body>
	...
	<table>
		...
		<tr>
			<td>%[num]s</td>
			<td>Tabs the text using spaces so they are all on the same tab<br>(in this case 10)<br><i>Note: You have to use <q>&lt;pre&gt;</q> to use it</i></td>
			<td><?php 
				print("<pre>");
				printf("%10s\n", "Hi");
				printf("%10s\n", "Hello");
		...
		<tr>
			<td>%%</td>
			<td>Displays a %</td>
			<td><?php printf("Here is %% for you") ?></td>
		</tr>
	</table>
