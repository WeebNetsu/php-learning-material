...
echo "<pre>Hello\tWorld!</pre>"; //pre allows you to use escape characters and renders it in the html
...
echo "<pre>I love ${bestAnimal}s</pre>"; //you can also bring in some ES6 syntax


// ! NOTE Do not show in tutorial!
$anArray = [20, 40, 19];
$myArray["age"] = 24;
